---
title: FAQ
description: "Answers on pricing and billing, choosing an LLM provider, whether code is stored, AGPL licensing, and how MergeWatch compares to CodeRabbit and Greptile."
---
...
<AccordionGroup>
  ...
  <Accordion title="Can I use MergeWatch on private repos?">
    Yes. The GitHub App requests `contents: read & write` — read to access diffs and file contents, write only to resolve review threads it created.
  </Accordion>
