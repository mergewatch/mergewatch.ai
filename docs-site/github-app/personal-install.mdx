...
description: "Install the MergeWatch GitHub App on a personal account, with setup steps, dashboard access, and the limitations versus an organization install."
---
