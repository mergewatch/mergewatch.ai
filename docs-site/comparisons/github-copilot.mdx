...
- You have strict GitHub-sole-vendor policies and can't introduce new third-party apps with `contents: read & write` (MergeWatch uses the write half only to resolve review threads it created, and works without it).
