---
title: "Prerequisites"
description: "The tools, GitHub permissions, and LLM provider credentials to gather before self-hosting MergeWatch, plus a preflight check to confirm readiness."
---
