...
description: "Run MergeWatch on your own infrastructure with Docker: what you get, supported LLM providers, the architecture, and how self-hosting compares to SaaS."
---
