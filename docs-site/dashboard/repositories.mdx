---
title: "Repositories"
description: "Choose which repositories MergeWatch actively reviews, understand the two-layer GitHub App and dashboard model, and read each repo card state."
---
