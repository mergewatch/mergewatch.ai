---
title: How It Works
description: "How MergeWatch reviews a pull request: architecture, webhook-to-comment flow, the parallel multi-agent pipeline, and codebase-aware file requests."
---
